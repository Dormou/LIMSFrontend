...
export const Agreement = (props: propsAgreement) => {
    ...
    const [openSendAgreementWindow, setOpenSendAgreementWindow] = useState(false)
    ...
    return (
        <div className={styles.main}>
            {openSendAgreementWindow &&
                <div className={styles.sendAgreementWindow}>
                    ...
                    <div className={styles.buttons}>
                        <button onClick={() => setOpenSendAgreementWindow(false)} className={styles.reject}>Отмена</button>
            ...
            <div className={styles.inline}>
                <button onClick={() => setOpenSendAgreementWindow(true)} disabled={isNotValidForm} className={styles.accept}>Отправить на согласование</button>
            </div>
        </div>
    )
}