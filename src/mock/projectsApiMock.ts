...
//                 },
//                 modelName: "SUR123",
//                 dateOfCreation: new Date(Date.now() - Date.now()/20000),
//                 dateOfLastUpdate: new Date(Date.now()),
...
//                 dateOfCreation: new Date(Date.now() - Date.now()/17000),
//                 dateOfLastUpdate: new Date(Date.now()),
...
//                         modelName: "SUR123",
//                         status: StatusProject.inWork,
//                 dateOfCreation: new Date(Date.now() - Date.now()/15000),
//                 dateOfLastUpdate: new Date(Date.now()),
...
//     }),
    ...
    http.post<PathParams, FetchProjectsRequest>('http://localhost:5075/projects/archive', async ({request}) => {
        const data = await request.json()
